        ...
        {isTypingPrompt ? (
          <div className="relative">
            ...
            <input
              ...
              className="h-8 w-[280px] border-none bg-background px-4 text-[11px] focus:outline-none"
            ...
            />
            <kbd className="-translate-y-1/2 pointer-events-none absolute top-1/2 right-2 h-5 select-none items-center gap-1 px-1.5 font-medium font-mono text-[13px]">
              <span>↵</span>
            </kbd>
          </div>
        ) : (
